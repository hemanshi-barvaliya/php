...
$sli_data = mysqli_query($con,$slider); 

$pro_data = mysqli_query($con,"SELECT product.*, category.name AS c_name FROM product INNER JOIN category ON product.category = category.id ORDER BY id DESC LIMIT 0,8");

$data = mysqli_query($con,"SELECT product.*, category.name AS c_name FROM product INNER JOIN category ON product.category = category.id ORDER BY id ASC LIMIT 0,3");

$blog_data = mysqli_query($con,"SELECT * FROM blog ORDER BY id DESC LIMIT 0,6");

if (isset($_GET['pro_id']))
{
   $pro_id = $_GET['pro_id'];
   $pro_sql = "SELECT * FROM product WHERE id=".$pro_id;
   $pro_sel = mysqli_query($con,$pro_sql);
}
...

{
	...
	$blog_sql= "SELECT * FROM blog WHERE id=".$blog_id;
	$blog_sel = mysqli_query($con,$blog_sql);
}
...
<div class="row">
    ...
    ?>
        <div class="col-md-4 mb-4 " >
            <div class="card rounded-0 product-card mx-4 mt-4">
                <div class="card-header bg-transparent border-bottom-0">
				    ...
				    <img style="height: 196px; width: 261px; display: block; margin: 0 auto;" 
				    src="../admin/image/<?php echo $data['image']; ?>" 
				    class="card-img-top" 
				    alt="...">
                <div class="card-body">
...
<?php } else { ?>		
						...
						<div class="carousel-item <?php echo $active; ?>">
							<div class="row d-flex align-items-center">
								<div class="col d-none d-lg-flex justify-content-center">
									<div class="">
										<h3 class="h3 fw-light"><?php echo $slider['subject']; ?></h3>
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<section class="py-4">
    <div class="container">
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2"> <!-- Changed to 2 products per row -->
            <div class="col">
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col">
                            <div class="card-body">
                                ...
                                <a href="product_list.php?cat_id=3" class="btn btn-light btn-ecomm">SHOP NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col">
                            <div class="card-body">
                                ...
                                <p class="card-text text-uppercase">Starting at $9</p>
                                <a href="product_list.php?cat_id=4;" class="btn btn-light btn-ecomm">SHOP NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col">
                            <div class="card-body">
                                ...
                                <p class="card-text text-uppercase">Starting at $9</p>
                                <a href="product_list.php?cat_id=5;" class="btn btn-light btn-ecomm">SHOP NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="d-flex align-items-center">
            ...
            <a href="product_list.php" class="btn btn-light ms-auto rounded-0">More Products<i class='bx bx-chevron-right'></i></a>
        </div>
        <hr/>
        <div class="product-grid">
                        ...
                        <div class="card rounded-0 product-card">
                            <div class="card-header bg-transparent border-bottom-0">
                                <div class="d-flex align-items-center justify-content-end gap-3">
                                    ...
                                    <a href="product_list.php?product_id=<?php echo $product['id']; ?>" class="btn btn-link btn-ecomm">
                                        <i class="bx bx-heart"></i>
                                    </a>
                                </div>
                            </div>
                            <a href="product-list.php?pro_id=<?php echo $product['id']; ?>">
                                <img style="height: 280px; width: 290px; display: block; margin-left: auto; margin-right: auto;" src="../admin/image/<?php echo $product['image']; ?>" class="card-img-top" alt="...">
                            </a>
                            <div class="card-body">
                                <div class="product-info">
                                    <a href="javascript:;">
                                        <p class="product-category font-13 mb-1"><?php echo $product['c_name']; ?></p>
                                    </a>
                                    <a href="javascript:;">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="mb-1 product-price">
                                            <span class="me-1 text-decoration-line-through">$<?php echo $product['basic']; ?></span>
                                    ...
                                    <div class="product-action mt-2">
                                        <div class="d-grid gap-2">
                                            <a href="product_list.php?p_id=<?php echo $product['id']; ?>" class="btn btn-link btn-ecomm">
            ...
            <!--end row-->
				...
				<section class="py-4">
					<div class="container">
						<div class="d-flex align-items-center">
							...
							<a href="product_list.php" class="btn btn-light ms-auto rounded-0">View All<i class='bx bx-chevron-right'></i></a>
						</div>
						<hr/>
						<div class="product-grid">
									...
									<div class="card rounded-0 product-card">
										<div class="card-header bg-transparent border-bottom-0">
											<div class="d-flex align-items-center justify-content-end">
												<a href="product_list.php?product_id=<?php echo $new_data['id']; ?>" class="btn btn-link btn-ecomm">
                                                            <i class="bx bx-heart"></i>
                                                        </a>
											</div>
										</div>
										<a href="product_list.php?pro_id=<?php echo $new_data['id'];?>">
											<img style="height: 280px; 
													width: 290px;
													display: block;
												    margin-left: auto;
												    margin-right: auto;" src="../admin/image/<?php echo $new_data['image'] ?>" class="card-img-top" alt="...">
										</a>
										<div class="card-body">
											<div class="product-info">
												<a href="javascript:;">
													<p class="product-category font-13 mb-1"><?php echo $new_data['c_name']; ?></p>
												</a>
												<a href="javascript:;">
												...
												<div class="product-action mt-2">
													<div class="d-grid gap-2">
														<a href="product_list.php?p_id=<?php echo $new_data['id']; ?>" class="btn btn-link btn-ecomm">
                                                                    <i class="bx bxs-cart-add"></i>Add to Cart</a>
													 <a href="#" class="btn btn-link btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i class='bx bx-zoom-in'></i>Quick View</a>
													</div>
												</div>
											</div>
										</div>
				...
				<section class="py-4">
					<div class="container">
						<div class="d-flex align-items-center">
							<h5 class="text-uppercase mb-0">Browse category</h5>
						...
						<div class="product-grid">
							<div class="latest-news owl-carousel owl-theme">
								<?php while ($blog=mysqli_fetch_assoc($blog_data)) {
									$con_sql="select * from comment where b_id=".$blog['id'];
									$comment = mysqli_query($con,$con_sql);
								...
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="blog.php?blog_id=<?php echo $blog['id']; ?>">
											<img style="height: 280px; 
													width: 260px;
													display: block;
												    margin-left: auto;
												    margin-right: auto;
												" src="../admin/image/<?php echo $blog['image'] ?>" class="card-img-top border-bottom bg-dark-1" alt="...">
										</a>
										<div class="card-body">
											...
											<p style="width: 280px; height: 63px;  overflow: hidden;" class="news-content mb-0"><?php echo $blog['description']; ?>...</p>
										</div>
