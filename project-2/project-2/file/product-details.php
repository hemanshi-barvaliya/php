				...
				<section class="py-3 border-bottom d-none d-md-flex">
					<div class="container">
						<div class="page-breadcrumb d-flex align-items-center">
							...
							<h3 class="breadcrumb-title pe-3"><?php echo $cat_data['name']; ?></h3>
							<?Php } ?>
							<div class="ms-auto">
...
<!-- Mirrored from codervent.com/etrans/demo/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Aug 2024 14:27:33 GMT -->
</html>
