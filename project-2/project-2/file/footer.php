							...
							<div class="footer-section2 mb-3">
								...
								<ul class="list-unstyled">
									<?php while ($res_cat=mysqli_fetch_assoc($sel_cat)) {?>
										<li>
											<a href="product_list.php?cat_id=<?php echo $res_cat['id']; ?>"><?php echo $res_cat['name']; ?></a>
										</li>
									<?php } ?>
...
<!-- Mirrored from codervent.com/etrans/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Aug 2024 14:25:07 GMT -->
</html>