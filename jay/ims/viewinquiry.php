                  ...
                  <tbody>
                    <?php $cnt=1; while($data = mysqli_fetch_assoc($inquiry_sql)){ ?>
                      <tr>
                        ...
                        <?php if($staff_data['role']!="Inquiry"){ ?>
                        <td align="center"> <a href="addstaff.php?u_id=<?php echo $data['inquiry_id']; ?>" class="text-primary">update</a> </td>
                        <?php } ?>
                        <td>
                          <a href="addfollowup.php?f_id=<?php echo $data['inquiry_id']; ?>" class="text-primary">Follow up</a>
                        </td>
                        <td>
                          <a href="assigninquiry.php?a_id=<?php echo $data['inquiry_id']; ?>" class="text-primary">Assign Inquiry</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
