<?php 
  ...
  if(isset($_POST['login']))
  {
    ...
    $sql = "select * form staff where email='$email' and password= '$password'";

    $data = mysqli_query($con,$sql);
    $rno = mysqli_num_rows($data);  
    $sel_data = mysqli_fetch_assoc($data);


    if($rno > 0)
    {
      $_SESSION['staff_id'] = $sel_data['staff_id'];
      header('location:dashboard.php');
    }
    else
    {
