...
if (isset($_GET['cat_id'])) {
	$cat_id = $_GET['cat_id'];
	$cat_sel=mysqli_query($connect,"SELECT product.* , catergory.name AS c_name FROM product INNER JOIN catergory ON product.catergory = catergory.id where product.catergory=$cat_id");
}else{

$cat_sel=mysqli_query($connect,"SELECT product.* , catergory.name AS c_name FROM product INNER JOIN catergory ON product.catergory = catergory.id ");
