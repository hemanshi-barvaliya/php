...
// 	$user_sel="select * from register where email='$email' and password='$password'";
// 	$user_id=mysqli_query($connect,$user_sel);

// 	$count=mysqli_num_raws($user_sel);

// 	if($count>0)
// 	{
// 			$data_user=mysqli_fetch_assoc($user_sel);
...
// }
  ...
  if (isset($_POST['submit']))
  {
    ...
    $user_sel=mysqli_query($connect,"select * from register where email='$email' and password='$password'");
